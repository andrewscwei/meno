...
Meno is an lean (`<13kb`), [WebComponents](http://webcomponents.org/)-based (namely custom elements) UI library. It is an experimental project and is not meant for production use.
